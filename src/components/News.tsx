...
export default () => {
    ...
    const newsIati = [
        ...
        {
            img: NewImage5,
            title: "Motocross na cidade: O melhor da região faz história e atrai pilotos e público de todo o país.",
        },
    ];
                ...
                <article className="relative row-span-2 overflow-hidden rounded-lg">
                    <Swiper
                        ...
                        pagination={{
                            clickable: true,
                            bulletClass:
                                "swiper-pagination-bullet bg-white opacity-60 w-3 h-3 rounded-full",
                            bulletActiveClass:
