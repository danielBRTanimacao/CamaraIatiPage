        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  to="https://tecnosolutions.inf.br/transparencia/iati/camara/"
              ...
              <li>
                <Link to="/vereadores" className="hover:text-white transition duration-300">
                  Vereadores
                </Link>
              </li>
            </ul>
          ...
          <div>
            <ul className="space-y-2">
              <li>
                <Link
                  to="https://tecnosolutions.inf.br/transparencia/iati/camara/esic.faces"
                  className="hover:text-white transition duration-300"
                >
                  e-SIC
                </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to="mailto:camaramunicipaldeiati@gmail.com"
                  className="hover:text-white transition duration-300"
                >
                  Email: camaramunicipaldeiati@gmail.com
                </Link>
              </li>
              <li>
                <Link
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-1">Siga-nos</h3>
